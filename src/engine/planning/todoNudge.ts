 ...
 *
 * 严格参照 $CC/tools/TodoWriteTool/TodoWriteTool.ts 第 75-87 行：
 * - 主 agent（不是子 agent）
 * - 列表长度 >= 3
 * - 全部完成
 * - 没有任何一项内容包含 "verif"
 ...
 * 生成 nudge 的文本内容
 *
 * 参照 $CC/tools/TodoWriteTool/TodoWriteTool.ts 第 105-107 行：
 ...
 *
 * 参照 $CC/tools/TodoWriteTool/TodoWriteTool.ts 第 104-114 行 mapToolResultToToolResultBlockParam
 */
